...
const FRAMEWORKS: FrameworkSpec[] = [
  ...
  },
  {
    ...
    configCandidates: [
      "lingui.config.ts", "lingui.config.js", ".linguirc",
    ],
  },
];
...
export function detectI18nFramework(root: string): I18nFrameworkInfo {
  ...
  for (const fw of FRAMEWORKS) {
    ...
    return { name: fw.name, version, configExists: configPath !== null, configPath };
  }

  return { name: null, version: null, configExists: false, configPath: null };
}
